...
exports.default = {
    ...
    mixins: [_comparable2.default, _dependent2.default, _filterable2.default],
    ...
    props: _extends({}, _VMenu2.default.props, _menuable2.default.props, {
        appendIcon: {
            type: String,
    ...
    methods: {
        ...
        genListWithSlot: function genListWithSlot() {
            return this.$createElement(_VSelectList2.default, this.listData, [this.$slots['no-data'] ? this.$createElement('div', {
                slot: 'no-data'
        ...
        setSelectedItems: function setSelectedItems() {
            ...
            var fn = !this.isMulti ? function (i) {
                return _this10.valueComparator(_this10.getValue(i), _this10.getValue(_this10.internalValue));
            } : function (i) {
                return _this10.findExistingIndex(i) > -1;
            };
